        ...
        nav.setOnItemSelectedListener(new BottomNavigationView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        startActivity(new Intent(Product_detail_Activity1.this, HomeActivity.class));
                        break;
                    case R.id.nav_like:
                        startActivity(new Intent(Product_detail_Activity1.this, Merchant_Inventory_Activity.class));
                        break;
                    case R.id.nav_profile:
                        startActivity(new Intent(Product_detail_Activity1.this, User_Profile_Activity.class));
                        break;
                    case R.id.nav_setting:
                        Toast.makeText(Product_detail_Activity1.this, "Feature Coming Soon", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        startActivity(new Intent(Product_detail_Activity1.this, HomeActivity.class));
                        return true;
