...
public class Product_detail_Activity3 extends AppCompatActivity {
...
//                Uri realUri = Uri.parse(sUri);
                ...
                NewPost np = dataSnapshot.child(postID[2]).getValue(NewPost.class);
                forTitle[2] = np.getName();
                forContent[2] = np.getDescription();
                forQuantity[2] = np.getQuantity();
                forUri[2] = np.getUri();

                title.setText(forTitle[2]);
                description.setText(forContent[2]);
                quantity.setText(forQuantity[2]);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Product_detail_Activity3.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}